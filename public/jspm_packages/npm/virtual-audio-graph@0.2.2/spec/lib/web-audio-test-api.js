...
(function(process) {
  (function e(t, n, r) {
    ...
    2: [function(require, module, exports) {
      ...
      var AudioBuffer = (function() {
        function AudioBuffer(admission, context, numberOfChannels, length, sampleRate) {
          ...
          Object.defineProperty(this, "_", {value: {inspector: new _utilsInspector2["default"](this)}});
    ...
    4: [function(require, module, exports) {
      ...
      "./AudioDestinationNode": 5,
      "./AudioListener": 6,
      "./BiquadFilterNode": 11,
      "./ChannelMergerNode": 12,
      "./ChannelSplitterNode": 13,
      "./ConvolverNode": 14,
      "./DelayNode": 15,
      "./DynamicsCompressorNode": 16,
      "./Event": 18,
      "./EventTarget": 19,
      "./GainNode": 20,
      "./MediaElementAudioSourceNode": 23,
      "./MediaStreamAudioDestinationNode": 25,
      "./MediaStreamAudioSourceNode": 26,
      "./OscillatorNode": 29,
      "./PannerNode": 30,
      "./PeriodicWave": 31,
      "./ScriptProcessorNode": 32,
      "./StereoPannerNode": 33,
      "./WaveShaperNode": 34,
      "./utils": 44,
      "./utils/Configuration": 37,
    ...
    37: [function(require, module, exports) {
      ...
      var _apiJson = require("./api.json!systemjs-json");
    ...
    43: [function(require, module, exports) {
      module.exports = {
        "AnalyserNode#getFloatTimeDomainData": {"states": ["disabled", "enabled"]},
        "AudioBuffer#copyToChannel": {"states": ["disabled", "enabled"]},
        "AudioBuffer#copyFromChannel": {"states": ["disabled", "enabled"]},
        "AudioContext#createAudioWorker": {"states": ["disabled", "enabled"]},
        "AudioContext#createStereoPanner": {"states": ["disabled", "enabled"]},
        "AudioContext#decodeAudioData": {"states": ["void", "promise"]},
        "AudioContext#close": {"states": ["disabled", "enabled"]},
        "AudioContext#suspend": {"states": ["disabled", "enabled"]},
        "AudioContext#resume": {"states": ["disabled", "enabled"]},
        "OfflineAudioContext#startRendering": {"states": ["void", "promise"]},
        "AudioNode#disconnect": {"states": ["channel", "selective"]}
      };
    }, {}],
    44: [function(require, module, exports) {
      ...
      function preventSuperCall(superClass) {
        function ctor() {}
        ctor.prototype = Object.create(superClass.prototype, {constructor: {
            value: ctor,
            enumerable: false,
            writable: true,
            configurable: true
