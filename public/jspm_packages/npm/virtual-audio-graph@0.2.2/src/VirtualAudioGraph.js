...
class VirtualAudioGraph {
  ...
  createVirtualAudioNodes(virtualAudioNodesParams) {
    const partitionedVirtualAudioNodeParams = partition(({node}) => isNil(this.customNodes[node]), virtualAudioNodesParams);
    ...
    const nativeVirtualAudioNodes = map((virtualAudioNodeParams) => new NativeVirtualAudioNode(this, virtualAudioNodeParams), nativeVirtualAudioNodeParams);
    const customVirtualAudioNodes = map((virtualAudioNodeParams) => new CustomVirtualAudioNode(this, virtualAudioNodeParams), customVirtualAudioNodeParams);
  ...
  update(virtualAudioNodeParams) {
    ...
    connectAudioNodes(CustomVirtualAudioNode, this.virtualNodes, (virtualAudioNode) => virtualAudioNode.connect(this.output));
    return this;
  }
}
