...
var Styles = {
  root: {font: '14px/1.4 Consolas, monospace'},
  line: {
    cursor: 'pointer',
    paddingLeft: '1em'
  },
  ...
  _createClass(Leaf, [{
    ...
    value: function renderValue() {
      ...
      if (typeof this.props.data === 'object' && this.props.data) {
        ...
        return _react2['default'].createElement('span', {style: Styles[jstype]}, String(this.props.data));
      }
    }
  }, {
    ...
    value: function renderLabel() {
      ...
      return _react2['default'].createElement('span', null, _react2['default'].createElement('span', {style: Styles.key}, label, ':'), _react2['default'].createElement('span', {style: Styles.helper}, type, ' ', this.renderPluralCount(length)));
    }
  }, {
    key: '_toggle',
    ...
    value: function render() {
      return _react2['default'].createElement('div', {style: Styles.line}, _react2['default'].createElement('span', {onClick: this.toggle}, this.renderLabel()), this.renderValue());
    }
  }]);
  return Leaf;
...
var Inspector = (function(_React$Component2) {
  ...
  _createClass(Inspector, [{
    key: 'render',
    value: function render() {
      return _react2['default'].createElement('div', {styles: Styles.root}, _react2['default'].createElement(Leaf, {
