...
var Debugger = (function(_React$Component) {
  ...
  _createClass(Debugger, [{
    ...
    value: function render() {
      return _react2['default'].createElement('div', null, _react2['default'].createElement('h1', null, 'Debug'), _react2['default'].createElement(_DispatcherDebugger2['default'], {alt: this.props.alt}), _react2['default'].createElement(_StoreExplorer2['default'], {alt: this.props.alt}), this.renderInspectorWindow());
    }
  }]);
  return Debugger;
