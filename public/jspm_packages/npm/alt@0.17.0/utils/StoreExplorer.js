...
var StoreExplorer = (function(_React$Component) {
  ...
  _createClass(StoreExplorer, [{
    ...
    value: function selectStore(ev) {
      ...
      if (store)
        _debugDebugActions2['default'].selectData(store.getState());
    }
  }, {
    key: 'render',
    value: function render() {
      var _this = this;
      return _react2['default'].createElement('div', null, _react2['default'].createElement('h3', null, 'Stores'), _react2['default'].createElement('ul', null, this.props.stores.map(function(store) {
...
exports['default'] = (0, _connectToStores2['default'])({
  getPropsFromStores: function getPropsFromStores() {
    return {stores: _debugAltStore2['default'].stores()};
  },
