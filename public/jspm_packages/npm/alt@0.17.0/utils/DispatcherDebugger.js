...
var DispatcherDebugger = (function(_React$Component) {
  ...
  _createClass(DispatcherDebugger, [{
    ...
    value: function loadRecording() {
      ...
      if (json)
        _debugDebugActions2['default'].loadRecording(json);
    }
  }, {
    key: 'revert',
    ...
    value: function renderReplay() {
      if (this.props.inReplayMode) {
        return _react2['default'].createElement('span', null, _react2['default'].createElement('span', {onClick: this.togglePauseReplay}, this.props.isReplaying ? 'Pause Replay' : 'Resume Replay'), ' | ', _react2['default'].createElement('span', {onClick: this.stopReplay}, 'Stop Replay'));
      }
      return _react2['default'].createElement('span', {onClick: this.startReplay}, 'Start Replay');
    }
  }, {
    key: 'renderRevert',
    value: function renderRevert(a, b, dispatch) {
      return _react2['default'].createElement('div', null, _react2['default'].createElement('span', {
        ...
        onClick: this.revert,
        style: {cursor: 'pointer'}
      }, 'Revert'), _react2['default'].createElement('span', {dangerouslySetInnerHTML: {__html: this.props.currentStateId === dispatch.id ? '&#10003;' : ''}}));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2['default'].createElement('div', null, _react2['default'].createElement('h3', null, 'Dispatches'), _react2['default'].createElement(_debugFixedDataTableCss2['default'], null), _react2['default'].createElement('div', null, _react2['default'].createElement('span', {onClick: this.toggleRecording}, this.props.isRecording ? 'Stop Recording' : 'Record'), ' | ', _react2['default'].createElement('span', {onClick: this.clear}, 'Clear'), ' | ', _react2['default'].createElement('span', {onClick: this.saveRecording}, 'Save'), ' | ', _react2['default'].createElement('span', {onClick: this.loadRecording}, 'Load'), ' | ', this.renderReplay()), _react2['default'].createElement(_fixedDataTable.Table, {
        headerHeight: 30,
        height: 480,
