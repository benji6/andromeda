...
(function(process) {
  !function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("react")) : "function" == typeof define && define.amd ? define(["react"], t) : "object" == typeof exports ? exports.Alt = t(require("react")) : e.Alt = t(e.react);
  }(this, function(e) {
    return function(e) {
      function t(r) {
        if (n[r])
      ...
      (function(t) {
        ...
        p.prototype = {_isReactElement: !0}, "production" !== t.env.NODE_ENV && o(p.prototype), p.createElement = function(e, t, n) {
          var r,
              o = {},
              s = null,
              u = null;
      ...
      Object.defineProperty(t, "__esModule", {value: !0}), t.eachObject = r, t.assign = o;
      var i = function(e) {
      ...
      (function(t) {
        ...
        function r(e, n, r) {
          for (var o in n)
            n.hasOwnProperty(o) && ("production" !== t.env.NODE_ENV ? O("function" == typeof n[o], "%s: %s type `%s` is invalid; it must be a function, usually from React.PropTypes.", e.displayName || "ReactClass", E[r], o) : null);
        }
        function o(e, n) {
          var r = T.hasOwnProperty(n) ? T[n] : null;
          I.hasOwnProperty(n) && ("production" !== t.env.NODE_ENV ? b(r === x.OVERRIDE_BASE, "ReactClassInterface: You are attempting to override `%s` from your class specification. Ensure that your method names do not overlap with React methods.", n) : b(r === x.OVERRIDE_BASE)), e.hasOwnProperty(n) && ("production" !== t.env.NODE_ENV ? b(r === x.DEFINE_MANY || r === x.DEFINE_MANY_MERGED, "ReactClassInterface: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.", n) : b(r === x.DEFINE_MANY || r === x.DEFINE_MANY_MERGED));
        }
        function i(e, n) {
          if (n) {
            "production" !== t.env.NODE_ENV ? b("function" != typeof n, "ReactClass: You're attempting to use a component class as a mixin. Instead, just use a regular object.") : b("function" != typeof n), "production" !== t.env.NODE_ENV ? b(!h.isValidElement(n), "ReactClass: You're attempting to use a component as a mixin. Instead, just use a regular object.") : b(!h.isValidElement(n));
            var r = e.prototype;
            n.hasOwnProperty(w) && P.mixins(e, n.mixins);
            for (var i in n)
              if (n.hasOwnProperty(i) && i !== w) {
                var a = n[i];
                if (o(r, i), P.hasOwnProperty(i))
                  P[i](e, a);
                else {
                  var s = T.hasOwnProperty(i),
                      l = r.hasOwnProperty(i),
                      p = a && a.__reactDontBind,
                      d = "function" == typeof a,
                      f = d && !s && !l && !p;
                  if (f)
                    r.__reactAutoBindMap || (r.__reactAutoBindMap = {}), r.__reactAutoBindMap[i] = a, r[i] = a;
                  else if (l) {
                    var m = T[i];
                    "production" !== t.env.NODE_ENV ? b(s && (m === x.DEFINE_MANY_MERGED || m === x.DEFINE_MANY), "ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.", m, i) : b(s && (m === x.DEFINE_MANY_MERGED || m === x.DEFINE_MANY)), m === x.DEFINE_MANY_MERGED ? r[i] = u(r[i], a) : m === x.DEFINE_MANY && (r[i] = c(r[i], a));
                  } else
                    r[i] = a, "production" !== t.env.NODE_ENV && "function" == typeof a && n.displayName && (r[i].displayName = n.displayName + "_" + i);
                }
              }
          }
        }
          ...
          if (n)
            for (var r in n) {
              ...
              if (n.hasOwnProperty(r)) {
                ...
                var a = r in e;
                "production" !== t.env.NODE_ENV ? b(!a, "ReactClass: You are attempting to define `%s` on your component more than once. This conflict may be due to a mixin.", r) : b(!a), e[r] = o;
              }
            }
        }
        function s(e, n) {
          ...
          for (var r in n)
            n.hasOwnProperty(r) && ("production" !== t.env.NODE_ENV ? b(void 0 === e[r], "mergeIntoWithNoDuplicateKeys(): Tried to merge two objects with the same key: `%s`. This conflict may be due to a mixin; in particular, this may be caused by two getInitialState() or getDefaultProps() methods returning objects with clashing keys.", r) : b(void 0 === e[r]), e[r] = n[r]);
          return e;
        }
        function u(e, t) {
          return function() {
        ...
        function l(e, n) {
          ...
          if ("production" !== t.env.NODE_ENV) {
            ...
            r.bind = function(a) {
              for (var s = [],
                  u = 1,
                  c = arguments.length; c > u; u++)
                s.push(arguments[u]);
              if (a !== e && null !== a)
                "production" !== t.env.NODE_ENV ? O(!1, "bind(): React component methods may only be bound to the component instance. See %s", o) : null;
              else if (!s.length)
                return "production" !== t.env.NODE_ENV ? O(!1, "bind(): You are binding a component method to the component. React does this for you automatically in a high-performance way, so you can safely remove this call. See %s", o) : null, r;
        ...
        var d = n(77),
            ...
            R = {
              ...
              get: function() {
                ...
                return "production" !== t.env.NODE_ENV ? O(!1, "%s.type is deprecated. Use %s directly to access the class.", e, e) : null, Object.defineProperty(this, "type", {value: this}), this;
              }
            },
            I = {
        ...
        var k = {
          createClass: function(e) {
            var n = function(e, r) {
              "production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? O(this instanceof n, "Something is calling a React component directly. Use a factory or JSX instead. See: https://fb.me/react-legacyfactory") : null), this.__reactAutoBindMap && p(this), this.props = e, this.context = r, this.state = null;
              var o = this.getInitialState ? this.getInitialState() : null;
              "production" !== t.env.NODE_ENV && "undefined" == typeof o && this.getInitialState._isMockFunction && (o = null), "production" !== t.env.NODE_ENV ? b("object" == typeof o && !Array.isArray(o), "%s.getInitialState(): must return an object or null", n.displayName || "ReactCompositeComponent") : b("object" == typeof o && !Array.isArray(o)), this.state = o;
            };
            n.prototype = new S, n.prototype.constructor = n, M.forEach(i.bind(null, n)), i(n, e), n.getDefaultProps && (n.defaultProps = n.getDefaultProps()), "production" !== t.env.NODE_ENV && (n.getDefaultProps && (n.getDefaultProps.isReactClassApproved = {}), n.prototype.getInitialState && (n.prototype.getInitialState.isReactClassApproved = {})), "production" !== t.env.NODE_ENV ? b(n.prototype.render, "createClass(...): Class specification must implement a `render` method.") : b(n.prototype.render), "production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? O(!n.prototype.componentShouldUpdate, "%s has a method called componentShouldUpdate(). Did you mean shouldComponentUpdate()? The name is phrased as a question because the function is expected to return a value.", e.displayName || "A component") : null);
            for (var r in T)
              n.prototype[r] || (n.prototype[r] = null);
            if (n.type = n, "production" !== t.env.NODE_ENV)
              try {
      ...
      (function(t) {
        ...
        function s(e) {
          ...
          "production" !== t.env.NODE_ENV ? y(n === E.length, "Expected flush transaction's stored dirty-components length (%s) to match dirty-components array length (%s).", n, E.length) : y(n === E.length), E.sort(a);
          for (var r = 0; n > r; r++) {
            var o = E[r],
        ...
        function u(e) {
          return r(), "production" !== t.env.NODE_ENV ? g(null == d.current, "enqueueUpdate(): Render methods should be a pure function of props and state; triggering nested component updates from render is not allowed. If necessary, trigger nested updates in componentDidUpdate.") : null, b.isBatchingUpdates ? void E.push(e) : void b.batchedUpdates(u, e);
        }
        function c(e, n) {
          "production" !== t.env.NODE_ENV ? y(b.isBatchingUpdates, "ReactUpdates.asap: Can't enqueue an asap callback in a context whereupdates are not being batched.") : y(b.isBatchingUpdates), N.enqueue(e, n), _ = !0;
        }
        var l = n(51),
            p = n(14),
            d = n(16),
            ...
            D = {
              ...
              close: function() {
                this.dirtyComponentsLength !== E.length ? (E.splice(0, this.dirtyComponentsLength), w()) : E.length = 0;
              }
            },
            C = {
              initialize: function() {
        ...
        var x = {
          injectReconcileTransaction: function(e) {
            "production" !== t.env.NODE_ENV ? y(e, "ReactUpdates: must provide a reconcile transaction class") : y(e), M.ReactReconcileTransaction = e;
          },
          injectBatchingStrategy: function(e) {
            "production" !== t.env.NODE_ENV ? y(e, "ReactUpdates: must provide a batching strategy") : y(e), "production" !== t.env.NODE_ENV ? y("function" == typeof e.batchedUpdates, "ReactUpdates: must provide a batchedUpdates() function") : y("function" == typeof e.batchedUpdates), "production" !== t.env.NODE_ENV ? y("boolean" == typeof e.isBatchingUpdates, "ReactUpdates: must provide an isBatchingUpdates boolean attribute") : y("boolean" == typeof e.isBatchingUpdates), b = e;
          }
        },
            M = {
      ...
      (function(t) {
        ...
        function i(e) {
          ...
          if (n)
            if (j.hasOwnProperty(n)) {
              var r = j[n];
              r !== e && ("production" !== t.env.NODE_ENV ? S(!l(r, n), "ReactMount: Two valid but unequal nodes with the same `%s`: %s", U, n) : S(!l(r, n)), j[n] = e);
            } else
              j[n] = e;
          return n;
        }
        ...
        function c(e) {
          ...
          return _.isNullComponentID(t) ? null : (j.hasOwnProperty(t) && l(j[t], t) || (j[t] = Y.findReactNodeByID(t)), j[t]);
        }
        function l(e, n) {
          if (e) {
        ...
        function f(e) {
          z = null, b.traverseAncestors(e, d);
          var t = z;
          return z = null, t;
        }
        ...
        var q = [],
            ...
            Y = {
              ...
              _updateRootComponent: function(e, n, r, i) {
                return "production" !== t.env.NODE_ENV && N.checkAndWarnForMutatedProps(n), Y.scrollMonitor(r, function() {
              ...
              _registerComponent: function(e, n) {
                "production" !== t.env.NODE_ENV ? S(n && (n.nodeType === F || n.nodeType === B), "_registerComponent(...): Target container is not a DOM element.") : S(n && (n.nodeType === F || n.nodeType === B)), y.ensureScrollValueMonitoring();
              ...
              _renderNewRootComponent: function(e, n, r) {
                ...
                return M.batchedUpdates(m, o, i, n, r), "production" !== t.env.NODE_ENV && (H[i] = R(n)), o;
              },
              render: function(e, n, r) {
                ...
                if (i) {
                  ...
                  if (A(a, e))
                    return Y._updateRootComponent(i, e, n, r).getPublicInstance();
                ...
                var l = u && !i,
                    p = Y._renderNewRootComponent(e, n, l).getPublicInstance();
                return r && r.call(p), p;
              },
              ...
              constructAndRenderComponentByID: function(e, n, r) {
                ...
                return "production" !== t.env.NODE_ENV ? S(o, 'Tried to get element with id of "%s" but it is not present on the page.', r) : S(o), Y.constructAndRenderComponent(e, n, o);
              },
              registerContainer: function(e) {
                var t = o(e);
                return t && (t = b.getReactRootIDFromNodeID(t)), t || (t = b.createReactRootID()), K[t] = e, t;
              },
              unmountComponentAtNode: function(e) {
                "production" !== t.env.NODE_ENV ? V(null == g.current, "unmountComponentAtNode(): Render methods should be a pure function of props and state; triggering nested component updates from render is not allowed. If necessary, trigger nested updates in componentDidUpdate.") : null, "production" !== t.env.NODE_ENV ? S(e && (e.nodeType === F || e.nodeType === B), "unmountComponentAtNode(...): Target container is not a DOM element.") : S(e && (e.nodeType === F || e.nodeType === B));
                var n = o(e),
                    r = W[n];
                return r ? (Y.unmountComponentFromNode(r, e), delete W[n], delete K[n], "production" !== t.env.NODE_ENV && delete H[n], !0) : !1;
              },
              unmountComponentFromNode: function(e, t) {
                for (w.unmountComponent(e), t.nodeType === B && (t = t.documentElement); t.lastChild; )
              ...
              findReactContainerForID: function(e) {
                ...
                if ("production" !== t.env.NODE_ENV) {
                  ...
                  if (o && o.parentNode !== r) {
                    ...
                    var i = r.firstChild;
                    i && n === a(i) ? H[n] = i : "production" !== t.env.NODE_ENV ? V(!1, "ReactMount: Root element has been removed from its original container. New container:", o.parentNode) : null;
                  }
                }
                return r;
              },
              ...
              findComponentRoot: function(e, n) {
                ...
                for (r[0] = i.firstChild, r.length = 1; o < r.length; ) {
                  for (var a,
                      s = r[o++]; s; ) {
                    var u = Y.getID(s);
                    u ? n === u ? a = s : b.isAncestorIDOf(u, n) && (r.length = o = 0, r.push(s.firstChild)) : r.push(s.firstChild), s = s.nextSibling;
                  }
                  if (a)
                    return r.length = 0, a;
                }
                r.length = 0, "production" !== t.env.NODE_ENV ? S(!1, "findComponentRoot(..., %s): Unable to find element. This probably means the DOM was unexpectedly mutated (e.g., by the browser), usually due to forgetting a <tbody> when using tables, nesting tags like <form>, <p>, or <a>, or using non-SVG elements in an <svg> parent. Try inspecting the child nodes of the element with React ID `%s`.", n, Y.getID(e)) : S(!1);
              },
              _mountImageIntoNode: function(e, n, o) {
                if ("production" !== t.env.NODE_ENV ? S(n && (n.nodeType === F || n.nodeType === B), "mountComponentIntoNode(...): Target container is not valid.") : S(n && (n.nodeType === F || n.nodeType === B)), o) {
                  var i = R(n);
                ...
                "production" !== t.env.NODE_ENV ? S(n.nodeType !== B, "You're trying to render a component to the document but you didn't use server rendering. We can't do this without using server rendering due to cross-browser quirks. See React.renderToString() for server rendering.") : S(n.nodeType !== B), k(n, e);
              },
              getReactRootID: o,
              getID: i,
              setID: s,
      ...
      function r(e, t) {
        ...
        return Object.getOwnPropertyNames(r).reduce(function(e, t) {
          return -1 !== n.indexOf(t) ? e : (e[t] = r[t], e);
        }, {});
      }
      function o(e) {
      ...
      function i(e, t) {
        for (var n = 0,
            r = t; Object.hasOwnProperty.call(e, r); )
          r = t + String(++n);
        return r;
      }
      function a(e) {
      ...
      function u() {}
      Object.defineProperty(t, "__esModule", {value: !0}), t.getInternalMethods = r, t.warn = o, t.uid = i, t.formatAsConstant = a, t.dispatchIdentity = s;
      ...
      (function(t) {
        ...
        function u(e, n) {
          if ("production" !== t.env.NODE_ENV ? d(i(e) && i(n), "getNextDescendantID(%s, %s): Received an invalid React DOM ID.", e, n) : d(i(e) && i(n)), "production" !== t.env.NODE_ENV ? d(a(e, n), "getNextDescendantID(...): React has made an invalid assumption about the DOM hierarchy. Expected `%s` to be an ancestor of `%s`.", e, n) : d(a(e, n)), e === n)
            return e;
          var r,
              s = e.length + h;
        ...
        function l(e, n, r, o, i, c) {
          ...
          for (var p = 0,
              ...
              h = e; ; h = f(h, n)) {
            var v;
            if (i && h === e || c && h === n || (v = r(h, l, o)), v === !1 || h === n)
              break;
      ...
      (function(t) {
        ...
        var w = v.measure("React", "render", m.render),
            x = {
              Children: {
                map: o.map,
                forEach: o.forEach,
        ...
        if ("undefined" != typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" == typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.inject && __REACT_DEVTOOLS_GLOBAL_HOOK__.inject({
          ...
          if (M.canUseDOM && window.top === window.self) {
            ...
            for (var T = [Array.isArray, Array.prototype.every, Array.prototype.forEach, Array.prototype.indexOf, Array.prototype.map, Date.now, Function.prototype.bind, Object.keys, String.prototype.split, String.prototype.trim, Object.create, Object.freeze],
                P = 0; P < T.length; P++)
              if (!T[P]) {
      ...
      (function(t) {
        ...
        var f = {
          create: function(e) {
            if ("production" !== t.env.NODE_ENV) {
              if ("object" != typeof e || !e || Array.isArray(e))
                return "production" !== t.env.NODE_ENV ? o(!1, "React.addons.createFragment only accepts a single object.", e) : null, e;
              if (r.isValidElement(e))
                return "production" !== t.env.NODE_ENV ? o(!1, "React.addons.createFragment does not accept a ReactElement without a wrapper object.") : null, e;
              if (s) {
                var n = {};
          ...
          extract: function(e) {
            return "production" !== t.env.NODE_ENV && s ? e[i] ? e[i] : ("production" !== t.env.NODE_ENV ? o(d(e), "Any use of a keyed object should be wrapped in React.addons.createFragment(object) before being passed as a child.") : null, e) : e;
          },
          extractIfFragment: function(e) {
            if ("production" !== t.env.NODE_ENV && s) {
              if (e[i])
                return e[i];
              for (var n in e)
                if (e.hasOwnProperty(n) && r.isValidElement(e[n]))
                  return f.extract(e);
            }
            return e;
          }
      ...
      (function(t) {
        ...
        var l = {
          ...
          createMarkupForProperty: function(e, n) {
            ...
            return o.isCustomAttribute(e) ? null == n ? "" : e + "=" + i(n) : ("production" !== t.env.NODE_ENV && c(e), null);
          },
          setValueForProperty: function(e, n, i) {
            if (o.isStandardName.hasOwnProperty(n) && o.isStandardName[n]) {
              ...
              o.isCustomAttribute(n) ? null == i ? e.removeAttribute(n) : e.setAttribute(n, "" + i) : "production" !== t.env.NODE_ENV && c(n);
          },
          deleteValueForProperty: function(e, n) {
            if (o.isStandardName.hasOwnProperty(n) && o.isStandardName[n]) {
              ...
              o.isCustomAttribute(n) ? e.removeAttribute(n) : "production" !== t.env.NODE_ENV && c(n);
          }
        };
        e.exports = l;
      }).call(t, n(1));
      ...
      (function(t) {
        ...
        function l(e, n, o, i) {
          for (var a in n)
            if (n.hasOwnProperty(a)) {
              var s;
              try {
                "production" !== t.env.NODE_ENV ? b("function" == typeof n[a], "%s: %s type `%s` is invalid; it must be a function, usually from React.PropTypes.", e || "React class", g[i], a) : b("function" == typeof n[a]), s = n[a](o, a, e, i);
              } catch (u) {
                s = u;
              }
        ...
        function h(e) {
          if (null != e.type) {
            var n = N.getComponentClassForElement(e),
        ...
        var m = n(4),
            ...
            M = {
              ...
              createFactory: function(e) {
                ...
                if (n.type = e, "production" !== t.env.NODE_ENV)
                  try {
                    Object.defineProperty(n, "type", {
                      enumerable: !1,
                      get: function() {
                        return "production" !== t.env.NODE_ENV ? D(!1, "Factory.type is deprecated. Access the class directly before passing it to createFactory.") : null, Object.defineProperty(this, "type", {value: e}), e;
                      }
                    });
                  } catch (r) {}
                return n;
        ...
        var r = n(2),
            o = {
              ...
              closeAll: function(e) {
                ...
                for (var n = this.transactionWrappers,
                    o = e; o < n.length; o++) {
                  var a,
                      s = n[o],
      ...
      function i(e, t, n, r, o) {
        var i = l.uid(e._actionsRegistry, "" + t + "." + n);
          ...
          name: n
            ...
            d = function() {
              for (var e = arguments.length,
                ...
                t[n] = arguments[n];
              s.dispatched = !1;
              var r = s._dispatch.apply(s, t);
              return s.dispatched || void 0 === r || (u.isFunction(r) ? r(c) : c(r)), r;
            };
        d.defer = function() {
          for (var e = arguments.length,
              t = Array(e),
      ...
      var s = n(7),
          ...
          p = function() {
            function e(t, n, r, i, a) {
              o(this, e), this.id = n, this._dispatch = r.bind(this), this.actions = i, this.actionDetails = a, this.alt = t;
            }
            return a(e, [{
              key: "dispatch",
              value: function(e) {
      ...
      var s = Function.prototype.bind,
          ...
          _ = function() {
            function e() {
              ...
              a(this, e), this.config = t, this.serialize = t.serialize || JSON.stringify, this.deserialize = t.deserialize || JSON.parse, this.dispatcher = t.dispatcher || new l.Dispatcher, this.batchingFunction = t.batchingFunction || function(e) {
                return e();
              }, this.actions = {global: {}}, this.stores = {}, this.storeTransforms = t.storeTransforms || [], this.trapAsync = !1, this._actionsRegistry = {}, this._initSnapshot = {}, this._lastSnapshot = {};
            }
            return c(e, [{
              key: "dispatch",
              value: function(e, t, n) {
                ...
                this.batchingFunction(function() {
                  var o = Math.random().toString(18).substr(2, 16);
              ...
              value: function(e) {
                for (var t = arguments.length,
                  ...
                  n[r - 1] = arguments[r];
                var o = e.displayName || "";
                v.createStoreConfig(this.config, e);
                var i = v.transformStore(this.storeTransforms, e);
                return h.isFunction(i) ? v.createStoreFromClass.apply(v, [this, i, o].concat(n)) : v.createStoreFromObject(this, i, o);
              }
            }, {
              key: "createStore",
              value: function(e, t) {
                for (var n = arguments.length,
                    ...
                    o = 2; n > o; o++)
                  r[o - 2] = arguments[o];
                var i = t || e.displayName || e.name || "";
                v.createStoreConfig(this.config, e);
                var a = v.transformStore(this.storeTransforms, e);
                (this.stores[i] || !i) && (g.warn(this.stores[i] ? "A store named " + i + " already exists, double check your store names or pass in your own custom identifier for each store" : "Store name was not specified"), i = g.uid(this.stores, i));
                var s = h.isFunction(a) ? v.createStoreFromClass.apply(v, [this, a, i].concat(r)) : v.createStoreFromObject(this, a, i);
                return this.stores[i] = s, d.saveInitialSnapshot(this, i), s;
              }
            }, {
              key: "generateActions",
              value: function() {
                for (var e = arguments.length,
                  ...
                  t[n] = arguments[n];
                var r = {name: "global"};
                return this.createActions(t.reduce(function(e, t) {
                  return e[t] = g.dispatchIdentity, e;
                }, r));
              }
            }, {
              key: "createAction",
              value: function(e, t, n) {
                return N["default"](this, "global", e, t, n);
              }
            }, {
              key: "createActions",
              value: function(e) {
                for (var t = arguments.length,
                  ...
                  n[r - 2] = arguments[r];
                var o = this,
                    l = void 0 === arguments[1] ? {} : arguments[1],
                    p = {},
                    d = g.uid(this._actionsRegistry, e.displayName || e.name || "Unknown");
                return h.isFunction(e) ? !function() {
                  h.assign(p, g.getInternalMethods(e, !0));
                  var t = function(e) {
                    function t() {
                      for (var e = arguments.length,
                          n = Array(e),
                          r = 0; e > r; r++)
                        n[r] = arguments[r];
                      a(this, t), u(Object.getPrototypeOf(t.prototype), "constructor", this).apply(this, n);
                    }
                    return i(t, e), c(t, [{
                      key: "generateActions",
                      value: function() {
                        ...
                        t.forEach(function(e) {
                          p[e] = g.dispatchIdentity;
                        });
                      }
                    }]), t;
                  }(e);
                  h.assign(p, new (s.apply(t, [null].concat(n))));
                }() : h.assign(p, e), this.actions[d] = this.actions[d] || {}, h.eachObject(function(e, t) {
                  if (h.isFunction(t)) {
                    l[e] = N["default"](o, d, e, t, l);
                    var n = g.formatAsConstant(e);
                    l[n] = l[e].id;
                  }
                }, [p]), l;
              }
              ...
              value: function() {
                for (var e = arguments.length,
                    ...
                    n = 0; e > n; n++)
                  t[n] = arguments[n];
                var r = d.snapshot(this, t);
                return h.assign(this._lastSnapshot, r), this.serialize(r);
              }
            }, {
              key: "rollback",
              value: function() {
                d.setAppState(this, this.serialize(this._lastSnapshot), function(e) {
              ...
              value: function() {
                for (var e = arguments.length,
                    ...
                    n = 0; e > n; n++)
                  t[n] = arguments[n];
                var r = t.length ? d.filterSnapshots(this, this._initSnapshot, t) : this._initSnapshot;
                d.setAppState(this, this.serialize(r), function(e) {
              ...
              key: "flush",
              value: function() {
                var e = this.serialize(d.snapshot(this));
                return this.recycle(), e;
              }
            }, {
              key: "bootstrap",
              value: function(e) {
                d.setAppState(this, e, function(e) {
              ...
              value: function(e, t) {
                for (var n = arguments.length,
                    ...
                    o = 2; n > o; o++)
                  r[o - 2] = arguments[o];
                this.actions[e] = Array.isArray(t) ? this.generateActions.apply(this, t) : this.createActions.apply(this, [t].concat(r));
              }
            }, {
              key: "addStore",
              value: function(e, t) {
                for (var n = arguments.length,
                    ...
                    o = 2; n > o; o++)
                  r[o - 2] = arguments[o];
                this.createStore.apply(this, [t, e].concat(r));
              }
            }, {
              key: "getActions",
              value: function(e) {
        ...
        return function(t, n, r) {
          ...
          p = function() {
            function e(t, n, r, o) {
              ...
              this.transmitter = l["default"](), this.lifecycle = function(e, t) {
                s[e] && s[e].push(t);
              }, this.state = r || n, this.preventDefault = !1, this.displayName = n.displayName, this.boundListeners = n.boundListeners, this.StoreModel = o;
              var c = n.output || function(e) {
                return e;
              };
              ...
              u.assign(this, n.publicMethods), this.dispatchToken = t.dispatcher.register(function(e) {
                ...
                n.reduce && (p(function() {
                  n.setState(n.reduce(a.state, e));
                }, e), a.preventDefault || a.emitChange()), a.lifecycle("afterEach", {
                  payload: e,
                  state: a.state
                });
              }), this.lifecycle("init");
            ...
            return a(e, [{
              ...
              value: function(e) {
                var t = this;
                return this.transmitter.subscribe(e), function() {
                  return t.unlisten(e);
                };
              }
            }, {
      ...
      var i = n(34),
          ...
          c = {
            waitFor: function() {
              ...
              var r = t;
              1 === t.length && (r = Array.isArray(t[0]) ? t[0] : t);
              var o = r.map(function(e) {
                return e.dispatchToken || e;
              });
              this.dispatcher.waitFor(o);
            },
            ...
            registerAsync: function(e) {
              var t = this,
                  n = 0,
                  r = u.isFunction(e) ? e(this.alt) : e,
                  o = Object.keys(r).reduce(function(e, o) {
                    var i = r[o],
                        a = u.isFunction(i) ? i(t) : i,
                    ...
                    return s.forEach(function(e) {
                      ...
                      var i = t.getInstance().getState(),
                          s = a.local && a.local.apply(a, [i].concat(r)),
                          u = a.shouldFetch ? a.shouldFetch.apply(a, [i].concat(r)) : null == s,
                          c = a.interceptResponse || function(e) {
                            return e;
                          },
                          l = function(e, o) {
                            return function(i) {
                      ...
                      return u ? (n += 1, a.loading && a.loading(c(null, a.loading, r)), a.remote.apply(a, [i].concat(r)).then(l(a.success), l(a.error, 1))) : void t.emitChange();
                    }, e;
                  }, {});
              this.exportPublicMethods(o), this.exportPublicMethods({isLoading: function() {
                  return n > 0;
                }});
            },
            exportPublicMethods: function(e) {
              var t = this;
              u.eachObject(function(e, n) {
                if (!u.isFunction(n))
            ...
            on: function(e, t) {
              ...
              var n = this.lifecycleEvents[e] || a["default"]();
            ...
            bindAction: function(e, t) {
              ...
              if (t.length > 1)
                throw new TypeError("Action handler in store " + this.displayName + " for " + ("" + (e.id || e).toString() + " was defined with ") + "two parameters. Only a single parameter is passed through the dispatcher, did you mean to pass in an Object instead?");
              var n = e.id ? e.id : e;
            ...
            bindActions: function(e) {
              ...
              u.eachObject(function(e, n) {
                var r = /./,
                    o = e.replace(r, function(e) {
                      return "on" + e[0].toUpperCase();
                    }),
                    i = null;
                if (t[e] && t[o])
                  throw new ReferenceError("You have multiple action handlers bound to an action: " + ("" + e + " and " + o));
                t[e] ? i = t[e] : t[o] && (i = t[o]), i && t.bindAction(n, i);
              }, [e]);
            },
            bindListeners: function(e) {
              ...
              u.eachObject(function(e, n) {
                var r = t[e];
                if (!r)
                  throw new ReferenceError("" + e + " defined but does not exist in " + t.displayName);
      ...
      function s(e, t, n) {
        if (n) {
          var r = t.StoreModel.config,
              o = g.isFunction(n) ? n(t.state) : n;
          t.state = r.setState.call(e, t.state, o), e.alt.dispatcher.isDispatching() || e.emitChange();
        }
      }
      function u(e, t, n, r) {
        return e.boundListeners = [], e.lifecycleEvents = {}, e.actionListeners = {}, e.publicMethods = {}, e.handlesOwnErrors = !1, g.assign(e, b["default"], {
          displayName: n,
          alt: t,
      ...
      function p(e, t, n) {
        ...
        return o.bindListeners && b["default"].bindListeners.call(o, o.bindListeners), o.observe && b["default"].bindListeners.call(o, o.observe(e)), o.lifecycle && g.eachObject(function(e, t) {
          b["default"].on.call(o, e, t);
        }, [o.lifecycle]), r = g.assign(new N["default"](e, o, o.state || {}, t), o.publicMethods, {displayName: n});
      }
      function d(e, t, n) {
            ...
            d = function(e) {
              function t() {
                for (var e = arguments.length,
                    ...
                    r = 0; e > r; r++)
                  n[r] = arguments[r];
                i(this, t), h(Object.getPrototypeOf(t.prototype), "constructor", this).apply(this, n);
              }
              return a(t, e), t;
            }(t);
        u(d.prototype, e, n, {
        ...
        var m = new (f.apply(d, [null].concat(o)));
        return p.bindListeners && m.bindListeners(p.bindListeners), p.datasource && m.registerAsync(p.datasource), l = g.assign(new N["default"](e, m, "object" == typeof m.state ? m.state : null, t), v.getInternalMethods(t), p.publicMethods, {displayName: n});
      }
      Object.defineProperty(t, "__esModule", {value: !0});
      ...
      t.createStoreConfig = c, t.transformStore = l, t.createStoreFromObject = p, t.createStoreFromClass = d;
      var m = n(19),
          v = o(m),
          y = n(7),
          g = o(y),
      ...
      function o(e, t, n) {
        var r = e.deserialize(t);
        c.eachObject(function(t, o) {
          var i = e.stores[t];
          i && !function() {
            var e = i.StoreModel.config,
                a = i.state;
            e.onDeserialize && (r[t] = e.onDeserialize(o) || o), c.eachObject(function(e) {
              return delete a[e];
            }, [a]), c.assign(a, r[t]), n(i);
          }();
        }, [r]);
      }
      function i(e) {
        ...
        return n.reduce(function(t, n) {
          var r = n.displayName || n,
              o = e.stores[r],
              i = o.StoreModel.config;
          o.lifecycle("snapshot");
          var a = i.onSerialize && i.onSerialize(o.state);
          return t[r] = a ? a : o.getState(), t;
        }, {});
      }
      function a(e, t) {
      ...
      function s(e, t, n) {
        return n.reduce(function(e, n) {
          var r = n.displayName || n;
          if (!t[r])
            throw new ReferenceError("" + r + " is not a valid store");
          return e[r] = t[r], e;
        }, {});
      }
      Object.defineProperty(t, "__esModule", {value: !0}), t.setAppState = o, t.snapshot = i, t.saveInitialSnapshot = a, t.filterSnapshots = s;
      var u = n(7),
          c = r(u);
    }, function(e, t, n) {
      ...
      (function(t) {
        ...
        function i(e) {
          R.call(P, e) || ("production" !== t.env.NODE_ENV ? y(T.test(e), "Invalid tag: %s", e) : y(T.test(e)), P[e] = !0);
        }
        function a(e) {
        ...
        a.displayName = "ReactDOMComponent", a.Mixin = {
            ...
            for (n in e)
              if (!a.hasOwnProperty(n) && e.hasOwnProperty(n))
                if (n === O) {
                  ...
                  D.hasOwnProperty(n) ? _(this._rootNodeID, n) : (u.isStandardName[n] || u.isCustomAttribute(n)) && x.deletePropertyByID(this._rootNodeID, n);
            for (n in a) {
              var c = a[n],
                  l = n === O ? this._previousStyleCopy : e[n];
              if (a.hasOwnProperty(n) && c !== l)
                if (n === O)
                  if (c ? c = this._previousStyleCopy = m({}, c) : this._previousStyleCopy = null, l) {
                    for (r in l)
                      !l.hasOwnProperty(r) || c && c.hasOwnProperty(r) || (i = i || {}, i[r] = "");
                    for (r in c)
                      c.hasOwnProperty(r) && l[r] !== c[r] && (i = i || {}, i[r] = c[r]);
                  } else
                    i = c;
                else
                  D.hasOwnProperty(n) ? o(this._rootNodeID, n, c, t) : (u.isStandardName[n] || u.isCustomAttribute(n)) && x.updatePropertyByID(this._rootNodeID, n, c);
            }
          ...
          _updateDOMChildren: function(e, t, n) {
            var r = this._currentElement.props,
                ...
                l = null != o || null != a,
                p = null != i || null != s;
            null != u && null == c ? this.updateChildren(null, t, n) : l && !p && this.updateTextContent(""), null != i ? o !== i && this.updateTextContent("" + i) : null != s ? a !== s && x.updateInnerHTMLByID(this._rootNodeID, s) : null != c && this.updateChildren(c, t, n);
          },
      ...
      (function(t) {
        ...
        function o(e, n) {
          ...
          var r = u.get(e);
          return r ? r === i.currentlyUnmountingInstance ? null : r : ("production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? d(!n, "%s(...): Can only update a mounted or mounting component. This usually means you called %s() on an unmounted component. This is a no-op.", n, n) : null), null);
        }
        var i = n(59),
            a = n(16),
            s = n(4),
            ...
            f = {
              ...
              enqueueCallbackInternal: function(e, n) {
                "production" !== t.env.NODE_ENV ? p("function" == typeof n, "enqueueCallback(...): You called `setProps`, `replaceProps`, `setState`, `replaceState`, or `forceUpdate` with a callback that isn't callable.") : p("function" == typeof n), e._pendingCallbacks ? e._pendingCallbacks.push(n) : e._pendingCallbacks = [n], r(e);
              },
      ...
      (function(t) {
        "use strict";
        function r(e, n) {
          if ("production" !== t.env.NODE_ENV ? o(null != n, "accumulateInto(...): Accumulated items must not be null or undefined.") : o(null != n), null == e)
            return n;
      ...
      (function(t) {
        ...
        function o(e, n) {
          ...
          if ((null === e || e === !1) && (e = a.emptyElement), "object" == typeof e) {
            var i = e;
            "production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? l(i && ("function" == typeof i.type || "string" == typeof i.type), "Only functions or strings can be mounted as React components.") : null), o = n === i.type && "string" == typeof i.type ? s.createInternalComponent(i) : r(i.type) ? new i.type(i) : new p;
          } else
            "string" == typeof e || "number" == typeof e ? o = s.createInstanceForText(e) : "production" !== t.env.NODE_ENV ? c(!1, "Encountered invalid React node of type %s", typeof e) : c(!1);
          return "production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? l("function" == typeof o.construct && "function" == typeof o.mountComponent && "function" == typeof o.receiveComponent && "function" == typeof o.unmountComponent, "Only React Components can be mounted.") : null), o.construct(e), o._mountIndex = 0, o._mountImage = null, "production" !== t.env.NODE_ENV && (o._isOwnerNecessary = !1, o._warnedAboutRefsInRender = !1), "production" !== t.env.NODE_ENV && Object.preventExtensions && Object.preventExtensions(o), o;
        }
        var i = n(78),
            a = n(36),
            s = n(37),
          ...
          if (null != e && null != n) {
            ...
            if ("object" === i && e.type === n.type && e.key === n.key) {
              var a = e._owner === n._owner,
                  ...
                  u = null,
                  c = null;
              return "production" !== t.env.NODE_ENV && (a || (null != e._owner && null != e._owner.getPublicInstance() && null != e._owner.getPublicInstance().constructor && (s = e._owner.getPublicInstance().constructor.displayName), null != n._owner && null != n._owner.getPublicInstance() && null != n._owner.getPublicInstance().constructor && (u = n._owner.getPublicInstance().constructor.displayName), null != n.type && null != n.type.displayName && (c = n.type.displayName), null != n.type && "string" == typeof n.type && (c = n.type), ("string" != typeof n.type || "input" === n.type || "textarea" === n.type) && (null != e._owner && e._owner._isOwnerNecessary === !1 || null != n._owner && n._owner._isOwnerNecessary === !1) && (null != e._owner && (e._owner._isOwnerNecessary = !0), null != n._owner && (n._owner._isOwnerNecessary = !0), "production" !== t.env.NODE_ENV ? o(!1, "<%s /> is being rendered by both %s and %s using the same key (%s) in the same place. Currently, this means that they don't preserve state. This behavior should be very rare so we're considering deprecating it. Please contact the React team and explain your use case so that we can take that into consideration.", c || "Unknown Component", s || "[Unknown]", u || "[Unknown]", e.key) : null))), a;
            }
          }
          return !1;
        }
      ...
      function r() {
        ...
        this.dispatcher.register(function(t) {
          var n = Object.keys(e.alt.stores).reduce(function(t, n) {
            return t.push(e.alt.stores[n].dispatchToken), t;
          }, []);
          e.waitFor(n), e.setState({payload: t}), e.emitChange();
        });
      }
      function o(e) {
        return e.FinalStore ? e.FinalStore : e.FinalStore = e.createUnsavedStore(r);
      }
      ...
      (function(t) {
        ...
        var r = n(73),
            ...
            p = "cssFloat";
        if (o.canUseDOM && void 0 === document.documentElement.style.cssFloat && (p = "styleFloat"), "production" !== t.env.NODE_ENV)
      ...
      (function(t) {
        ...
        function r() {
          if (s)
            for (var e in u) {
              var n = u[e],
                  r = s.indexOf(e);
              if ("production" !== t.env.NODE_ENV ? a(r > -1, "EventPluginRegistry: Cannot inject event plugins that do not exist in the plugin ordering, `%s`.", e) : a(r > -1), !c.plugins[r]) {
                "production" !== t.env.NODE_ENV ? a(n.extractEvents, "EventPluginRegistry: Event plugins must implement an `extractEvents` method, but `%s` does not.", e) : a(n.extractEvents), c.plugins[r] = n;
                var i = n.eventTypes;
                for (var l in i)
                  "production" !== t.env.NODE_ENV ? a(o(i[l], n, l), "EventPluginRegistry: Failed to publish event `%s` for plugin `%s`.", l, e) : a(o(i[l], n, l));
              }
            }
        }
        function o(e, n, r) {
          "production" !== t.env.NODE_ENV ? a(!c.eventNameDispatchConfigs.hasOwnProperty(r), "EventPluginHub: More than one plugin attempted to publish the same event name, `%s`.", r) : a(!c.eventNameDispatchConfigs.hasOwnProperty(r)), c.eventNameDispatchConfigs[r] = e;
        ...
        function i(e, n, r) {
          "production" !== t.env.NODE_ENV ? a(!c.registrationNameModules[e], "EventPluginHub: More than one plugin attempted to publish the same registration name, `%s`.", e) : a(!c.registrationNameModules[e]), c.registrationNameModules[e] = n, c.registrationNameDependencies[e] = n.eventTypes[r].dependencies;
        }
        var a = n(2),
            s = null,
            u = {},
        ...
        if (r.prototype.setState = function(e, n) {
          ...
          var s = {
            ...
            setProps: ["setProps", "Instead, call React.render again at the top level."]
              ...
              u = function(e, n) {
                try {
                  Object.defineProperty(r.prototype, e, {get: function() {
        ...
        var o = n(56),
            ...
            D = {
              ...
              mountComponent: function(e, n, r) {
                ...
                var u = s.state;
                void 0 === u && (s.state = u = null), "production" !== t.env.NODE_ENV ? E("object" == typeof u && !Array.isArray(u), "%s.state: must be set to an object or null", this.getName() || "ReactCompositeComponent") : E("object" == typeof u && !Array.isArray(u)), this._pendingStateQueue = null, this._pendingReplaceState = !1, this._pendingForceUpdate = !1;
                var d,
                    f,
              ...
              _getValidatedChildContext: function(e) {
                ...
                if (r) {
                  "production" !== t.env.NODE_ENV ? E("object" == typeof n.constructor.childContextTypes, "%s.getChildContext(): childContextTypes must be defined in order to use getChildContext().", this.getName() || "ReactCompositeComponent") : E("object" == typeof n.constructor.childContextTypes), "production" !== t.env.NODE_ENV && this._checkPropTypes(n.constructor.childContextTypes, r, f.childContext);
                  for (var o in r)
                    "production" !== t.env.NODE_ENV ? E(o in n.constructor.childContextTypes, '%s.getChildContext(): key "%s" is not defined in childContextTypes.', this.getName() || "ReactCompositeComponent", o) : E(o in n.constructor.childContextTypes);
                  return r;
                }
                return null;
              },
              ...
              _checkPropTypes: function(e, n, o) {
                ...
                for (var a in e)
                  if (e.hasOwnProperty(a)) {
                    var s;
                    try {
                      "production" !== t.env.NODE_ENV ? E("function" == typeof e[a], "%s: %s type `%s` is invalid; it must be a function, usually from React.PropTypes.", i || "React class", h[o], a) : E("function" == typeof e[a]), s = e[a](n, a, i, o);
                    } catch (u) {
                      s = u;
                    }
              ...
              _warnIfContextsDiffer: function(e, n) {
                ...
                for (var r = Object.keys(n).sort(),
                    o = this.getName() || "ReactCompositeComponent",
                    i = 0; i < r.length; i++) {
                  var a = r[i];
                  "production" !== t.env.NODE_ENV ? _(e[a] === n[a], "owner-based and parent-based contexts differ (values: `%s` vs `%s`) for key (%s) while mounting %s (see: http://fb.me/react-context-by-parent)", e[a], n[a], a, o) : null;
                }
              },
              ...
              _updateRenderedComponent: function(e, t) {
                ...
                if (N(r, i))
                  m.receiveComponent(n, i, e, this._mergeChildContext(t, o));
                else {
              ...
              _renderValidatedComponent: function(e) {
                ...
                return "production" !== t.env.NODE_ENV ? E(null === n || n === !1 || s.isValidElement(n), "%s.render(): A valid ReactComponent must be returned. You may have returned undefined, an array or some other invalid object.", this.getName() || "ReactCompositeComponent") : E(null === n || n === !1 || s.isValidElement(n)), n;
              },
        ...
        var r = n(74),
            ...
            p = {
              updatePropertyByID: function(e, n, r) {
                var o = a.getNode(e);
                "production" !== t.env.NODE_ENV ? u(!l.hasOwnProperty(n), "updatePropertyByID(...): %s", l[n]) : u(!l.hasOwnProperty(n)), null != r ? i.setValueForProperty(o, n, r) : i.deleteValueForProperty(o, n);
              },
              deletePropertyByID: function(e, n, r) {
                var o = a.getNode(e);
                "production" !== t.env.NODE_ENV ? u(!l.hasOwnProperty(n), "updatePropertyByID(...): %s", l[n]) : u(!l.hasOwnProperty(n)), i.deleteValueForProperty(o, n, r);
              },
              ...
              return function() {
                ...
                if ("_mountImageIntoNode" === t || "ReactDOMIDOperations" === e) {
                  if (d = c(), p = n.apply(this, r), u = c() - d, "_mountImageIntoNode" === t) {
                    ...
                    "dangerouslyProcessChildrenUpdates" === t ? r[0].forEach(function(e) {
                      var t = {};
                ...
                if (m ? o(g.counts, h, 1) : v && y.push(0), d = c(), p = n.apply(this, r), u = c() - d, m)
                  o(g.render, h, u);
                else if (v) {
                  var E = y.pop();
      ...
      (function(t) {
        ...
        function s(e, n, r, i, u) {
          var p = typeof e;
          if (("undefined" === p || "boolean" === p) && (e = null), null === e || "string" === p || "number" === p || c.isValidElement(e))
            return i(u, e, "" === n ? m + o(e, 0) : n, r), 1;
          var y,
              g,
              N,
              _ = 0;
          if (Array.isArray(e))
            for (var b = 0; b < e.length; b++)
              y = e[b], g = ("" !== n ? n + v : m) + o(y, b), N = r + _, _ += s(y, g, N, i, u);
          else {
            var D = d(e);
            if (D) {
              var C,
                  O = D.call(e);
              if (D !== e.entries)
                for (var w = 0; !(C = O.next()).done; )
                  y = C.value, g = ("" !== n ? n + v : m) + o(y, w++), N = r + _, _ += s(y, g, N, i, u);
              else
                for ("production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? h(E, "Using Maps as children is not yet fully supported. It is an experimental feature that might be removed. Convert it to a sequence / iterable of keyed ReactElements instead.") : null, E = !0); !(C = O.next()).done; ) {
                  var x = C.value;
                  x && (y = x[1], g = ("" !== n ? n + v : m) + a(x[0]) + v + o(y, 0), N = r + _, _ += s(y, g, N, i, u));
                }
            } else if ("object" === p) {
              ...
              var M = l.extract(e);
              for (var T in M)
                M.hasOwnProperty(T) && (y = M[T], g = ("" !== n ? n + v : m) + a(T) + v + o(y, 0), N = r + _, _ += s(y, g, N, i, u));
            }
          }
          return _;
        }
      ...
      function a(e) {
        ...
        return {
          contextTypes: {flux: e.PropTypes.object},
          childContextTypes: {flux: e.PropTypes.object},
          ...
          getStateFromStores: function(e) {
            var t = e.stores;
            return e.store ? o(e.store, e) : e.stores ? Array.isArray(t) ? void 0 : Object.keys(t).reduce(function(n, r) {
              return n[r] = o(t[r], e), n;
            }, {}) : {};
          },
          getStateFromActions: function(e) {
            return e.actions ? i(e.actions, e) : {};
          },
          getInjected: function(e) {
            return e.inject ? Object.keys(e.inject).reduce(function(t, n) {
              return t[n] = i(e.inject[n], e), t;
            }, {}) : {};
          },
          reduceState: function(e) {
            return u({}, this.getStateFromStores(e), this.getStateFromActions(e), this.getInjected(e));
          },
          ...
          getProps: function() {
            var e = this.props.flux || this.context.flux,
                t = "function" == typeof this.props.transform ? this.props.transform : r;
            return t(u(e ? {flux: e} : {}, this.state));
          },
          ...
          altRender: function(n) {
            ...
            return "function" == typeof this.props.render ? this.props.render(this.getProps()) : this.props.component ? e.createElement(this.props.component, this.getProps()) : Array.isArray(r) ? e.createElement(n, null, r.map(function(e, n) {
              return t(e, u({key: n}, this.getProps()));
            }, this)) : r ? t(r, this.getProps()) : e.createElement(n, this.getProps());
          }
        };
      }
      var s = n(107),
      ...
      var o = n(43),
          ...
          D = r(b);
      i["default"].addons = {
        ActionListeners: s["default"],
        AltContainer: D["default"],
        AltManager: c["default"],
        DispatcherRecorder: p["default"],
        atomic: f["default"],
        chromeDebug: y["default"],
        connectToStores: m["default"],
        makeFinalStore: E["default"],
        withAltContext: _["default"]
      }, t["default"] = i["default"], e.exports = t["default"];
    }, function(e, t, n) {
      "use strict";
      function r(e) {
        this.dispatcher = e.dispatcher, this.listeners = {};
      }
      Object.defineProperty(t, "__esModule", {value: !0}), r.prototype.addActionListener = function(e, t) {
        var n = this.dispatcher.register(function(n) {
          e === n.action && t(n.data, n.details);
        });
        return this.listeners[n] = !0, n;
      }, r.prototype.removeActionListener = function(e) {
        delete this.listeners[e], this.dispatcher.unregister(e);
      }, r.prototype.removeAllActionListeners = function() {
        Object.keys(this.listeners).forEach(this.removeActionListener.bind(this)), this.listeners = {};
      ...
      var o = function() {
        ...
        return function(t, n, r) {
          ...
          i = function() {
            function e(t) {
              r(this, e), this.Alt = t, this.alts = {};
            }
            return o(e, [{
              key: "create",
              value: function(e) {
                if (this.get(e))
                  throw new ReferenceError("Alt key " + e + " already exists");
                if ("string" != typeof e)
                  throw new TypeError("altKey must be a string");
                return this.alts[e] = new this.Alt, this.alts[e];
              }
            }, {
              key: "get",
              value: function(e) {
              ...
              value: function(e) {
                var t = {};
                for (var n in this.alts)
                  null !== e.exec(n) && (t[n] = this.alts[n]);
                return t;
              }
            }, {
              key: "delete",
              value: function(e) {
                return this.get(e) ? (delete this.alts[e], !0) : !1;
              }
            }, {
              key: "getOrCreate",
              value: function(e) {
                var t = this.get(e);
                return t ? t : this.create(e);
              }
            }]), e;
          }();
      ...
      "use strict";
      function r(e) {
        var t = void 0 === arguments[1] ? 1 / 0 : arguments[1];
        this.alt = e, this.events = [], this.dispatchToken = null, this.maxEvents = t;
      }
      Object.defineProperty(t, "__esModule", {value: !0}), r.prototype.record = function() {
        var e = this;
        return this.dispatchToken ? !1 : (this.dispatchToken = this.alt.dispatcher.register(function(t) {
          e.events.length < e.maxEvents && e.events.push(t);
        }), !0);
      }, r.prototype.stop = function() {
        this.alt.dispatcher.unregister(this.dispatchToken), this.dispatchToken = null;
      }, r.prototype.clear = function() {
        this.events = [];
      }, r.prototype.replay = function(e, t) {
        var n = this.alt;
        void 0 === e && this.events.forEach(function(e) {
          n.dispatch(e.action, e.data);
        });
        for (var r = function(t, r) {
          return function() {
            setTimeout(function() {
              n.dispatch(t.action, t.data), r();
            }, e);
          };
        },
            o = t || function() {},
            i = this.events.length - 1; i >= 0; ) {
          var a = this.events[i];
          o = r(a, o), i -= 1;
        }
        o();
      }, r.prototype.serializeEvents = function() {
        var e = this.events.map(function(e) {
          return {
            id: e.id,
            action: e.action,
            data: e.data || {}
      ...
      }, r.prototype.loadEvents = function(e) {
        var t = JSON.parse(e);
        return this.events = t.map(function(e) {
          return {
            action: e.action,
            data: e.data
          };
      ...
      function a(e, t) {
        var n = function(t) {
          function n() {
            o(this, n), c(Object.getPrototypeOf(n.prototype), "constructor", this).call(this), this.on("error", function() {
              return e.rollback();
            });
          }
          return i(n, t), n;
      ...
      function s(e, t) {
        return t.lifecycle = t.lifecycle || {}, t.lifecycle.error = function() {
          e.rollback();
        }, t;
      }
      function u(e) {
        ...
        return t.listen(function() {
          ...
          return d.isFunction(t) ? a(e, t) : s(e, t);
        };
      }
      Object.defineProperty(t, "__esModule", {value: !0});
      ...
      function o(e) {
        var t = void 0 === arguments[1] ? e : arguments[1];
        return function() {
          if (!s.isFunction(e.getStores))
            throw new Error("connectToStores() expects the wrapped component to have a static getStores() method");
          if (!s.isFunction(e.getPropsFromStores))
            throw new Error("connectToStores() expects the wrapped component to have a static getPropsFromStores() method");
          var n = a["default"].createClass({
            ...
            render: function() {
              return a["default"].createElement(t, s.assign({}, this.props, this.state));
            }
          });
          return n;
        }();
      ...
      function o(e) {
        return function(t) {
          return a["default"].createClass({
            childContextTypes: {flux: a["default"].PropTypes.object},
            getChildContext: function() {
              return {flux: e};
            },
            render: function() {
      ...
      function c(e, t, n, r) {
        var o,
            c;
        if (b ? o = i(e) : R ? s(e, r) && (o = T.compositionEnd) : a(e, r) && (o = T.compositionStart), !o)
          return null;
        O && (R || o !== T.compositionStart ? o === T.compositionEnd && R && (c = R.getData()) : R = v.getPooled(t));
      ...
      var C = m.canUseDOM && "TextEvent" in window && !D && !r(),
          O = m.canUseDOM && (!b || D && D > 8 && 11 >= D),
          w = 32,
        ...
        var r = n(2),
            o = {
              addClass: function(e, n) {
                return "production" !== t.env.NODE_ENV ? r(!/\s/.test(n), 'CSSCore.addClass takes only a single class name. "%s" contains multiple classes.', n) : r(!/\s/.test(n)), n && (e.classList ? e.classList.add(n) : o.hasClass(e, n) || (e.className = e.className + " " + n)), e;
              },
              removeClass: function(e, n) {
                return "production" !== t.env.NODE_ENV ? r(!/\s/.test(n), 'CSSCore.removeClass takes only a single class name. "%s" contains multiple classes.', n) : r(!/\s/.test(n)), n && (e.classList ? e.classList.remove(n) : o.hasClass(e, n) && (e.className = e.className.replace(new RegExp("(^|\\s)" + n + "(?:\\s|$)", "g"), "$1").replace(/\s+/g, " ").replace(/^\s*|\s*$/g, ""))), e;
              },
      ...
      function o(e) {
        var t = D.getPooled(M.change, P, e);
        N.accumulateTwoPhaseDispatches(t), b.batchedUpdates(i, t);
      }
      function i(e) {
        E.enqueueEvents(e), E.processEventQueue();
      }
      function a(e, t) {
        T = e, P = t, T.attachEvent("onchange", o);
      }
      function s() {
        T && (T.detachEvent("onchange", o), T = null, P = null);
      }
      function u(e, t, n) {
      ...
      function l(e, t) {
        T = e, P = t, R = e.value, I = Object.getOwnPropertyDescriptor(e.constructor.prototype, "value"), Object.defineProperty(T, "value", A), T.attachEvent("onpropertychange", d);
      }
      function p() {
        T && (delete T.value, T.detachEvent("onpropertychange", d), T = null, P = null, R = null, I = null);
      }
      function d(e) {
      ...
      function m(e, t, n) {
        return e !== x.topSelectionChange && e !== x.topKeyUp && e !== x.topKeyDown || !T || T.value === R ? void 0 : (R = T.value, P);
      }
      function v(e) {
      ...
      var g = n(8),
          ...
          I = null,
          S = !1;
      _.canUseDOM && (S = C("change") && (!("documentMode" in document) || document.documentMode > 8));
      var k = !1;
      _.canUseDOM && (k = C("input") && (!("documentMode" in document) || document.documentMode > 9));
      var A = {
        get: function() {
        ...
        set: function(e) {
          ...
          V = {
            ...
            extractEvents: function(e, t, n, o) {
              var i,
                  a;
              if (r(t) ? S ? i = u : a = c : O(t) ? k ? i = f : (i = m, a = h) : v(t) && (i = y), i) {
                var s = i(e, t, n);
                if (s) {
            ...
            p = {
              dangerouslyRenderMarkup: function(e) {
                ...
                for (var n,
                    p = {},
                    d = 0; d < e.length; d++)
                  "production" !== t.env.NODE_ENV ? u(e[d], "dangerouslyRenderMarkup(...): Missing markup.") : u(e[d]), n = r(e[d]), n = s(n) ? n : "*", p[n] = p[n] || [], p[n][d] = e[d];
                var f = [],
                    h = 0;
                for (n in p)
                  if (p.hasOwnProperty(n)) {
                    ...
                    for (var g = i(v.join(""), a),
                        E = 0; E < g.length; ++E) {
                      var N = g[E];
                      N.hasAttribute && N.hasAttribute(l) ? (m = +N.getAttribute(l), N.removeAttribute(l), "production" !== t.env.NODE_ENV ? u(!f.hasOwnProperty(m), "Danger: Assigning to an already-occupied result index.") : u(!f.hasOwnProperty(m)), f[m] = N, h += 1) : "production" !== t.env.NODE_ENV && console.error("Danger: Discarding unexpected node:", N);
                    }
                  }
      ...
      var r = n(8),
          ...
          d = {
            ...
            extractEvents: function(e, t, n, r) {
              ...
              var f,
                  h;
              if (e === u.topMouseOut ? (f = t, h = c(r.relatedTarget || r.toElement) || s) : (f = s, h = t), f === h)
                return null;
              var m = f ? a.getID(f) : "",
                  v = h ? a.getID(h) : "",
        ...
        var r = n(12),
            o = {
              ...
              capture: function(e, n, o) {
                return e.addEventListener ? (e.addEventListener(n, o, !0), {remove: function() {
      ...
      var r = n(26),
          o = n(3),
          i = r.createFactory(n(88)),
          a = r.createFactory(n(131)),
          s = r.createClass({
      ...
      (function(t) {
        ...
        "production" !== t.env.NODE_ENV && (l = function() {
          "production" !== t.env.NODE_ENV ? s(!1, "transition(): tried to perform an animation without an animationend or transitionend event after timeout (%sms). You should either disable this transition in JS or add a CSS animation/transition.", c) : null;
        });
        var p = r.createClass({
          ...
          transition: function(e, n) {
            var r = this.getDOMNode(),
                ...
                u = null,
                p = function(e) {
                  e && e.target !== r || ("production" !== t.env.NODE_ENV && clearTimeout(u), o.removeClass(r, a), o.removeClass(r, s), i.removeEndEventListener(r, p), n && n());
                };
            i.addEndEventListener(r, p), o.addClass(r, a), this.queueClass(s), "production" !== t.env.NODE_ENV && (u = setTimeout(l, c));
          },
      ...
      var r = n(28),
          ...
          s = {
            ...
            updateChildren: function(e, t, n, s) {
              ...
              for (c in u)
                if (u.hasOwnProperty(c)) {
                  var l = e && e[c],
                      ...
                      d = u[c];
                  if (a(p, d))
                    r.receiveComponent(l, d, n, s), u[c] = l;
                  else {
              ...
              for (c in e)
                !e.hasOwnProperty(c) || u && u.hasOwnProperty(c) || r.unmountComponent(e[c]);
              return u;
            },
            ...
            v = u.createClass({
              ...
              _handleChange: function(e) {
                ...
                if ("radio" === this.props.type && null != i) {
                  for (var s = this.getDOMNode(),
                      u = s; u.parentNode; )
                    u = u.parentNode;
                  for (var c = u.querySelectorAll("input[name=" + JSON.stringify("" + i) + '][type="radio"]'),
                      d = 0,
                      h = c.length; h > d; d++) {
                    var v = c[d];
                    if (v !== s && v.form === s.form) {
                      ...
                      var g = m[y];
                      "production" !== t.env.NODE_ENV ? f(g, "ReactDOMInput: Unknown radio button ID %s.", y) : f(g), p.asap(r, g);
                    }
                  }
                }
                return n;
      ...
      (function(t) {
        ...
        function o() {
          if (P.EventEmitter.injectReactEventListener(T), P.EventPluginHub.injectEventPluginOrder(u), P.EventPluginHub.injectInstanceHandle(R), P.EventPluginHub.injectMount(I), P.EventPluginHub.injectEventPluginsByName({
            SimpleEventPlugin: V,
          ...
          }), P.NativeComponent.injectGenericComponentClass(y), P.NativeComponent.injectTextComponentClass(x), P.NativeComponent.injectAutoWrapper(r), P.Class.injectMixin(f), P.NativeComponent.injectComponentClasses({
            button: g,
            form: E,
            iframe: b,
            img: N,
            ...
            head: U("head"),
            body: U("body")
          }), P.DOMProperty.injectDOMPropertyConfig(p), P.DOMProperty.injectDOMPropertyConfig(L), P.EmptyComponent.injectEmptyComponent("noscript"), P.Updates.injectReconcileTransaction(S), P.Updates.injectBatchingStrategy(v), P.RootIndex.injectCreateReactRootIndex(l.canUseDOM ? s.createReactRootIndex : A.createReactRootIndex), P.Component.injectEnvironment(m), P.DOMComponent.injectIDOperations(_), "production" !== t.env.NODE_ENV) {
      ...
      function o(e) {
        return function(t, n) {
          var o;
          D.isDOMComponent(t) ? o = t.getDOMNode() : t.tagName && (o = t);
          var i = new r;
          i.target = o;
          var a = new E(f.eventNameDispatchConfigs[e], y.getID(o), i);
          N(a, n), c.accumulateTwoPhaseDispatches(a), g.batchedUpdates(function() {
      ...
      function i() {
        D.Simulate = {};
        var e;
        for (e in f.eventNameDispatchConfigs)
          D.Simulate[e] = o(e);
      }
      function a(e) {
        return function(t, n) {
          var o = new r(e);
          N(o, n), D.isDOMComponent(t) ? D.simulateNativeEventOnDOMComponent(e, t, o) : t.tagName && D.simulateNativeEventOnNode(e, t, o);
        };
      }
      var s = n(8),
          u = n(24),
          ...
          D = {
            ...
            isCompositeComponentWithType: function(e, t) {
              return !(!D.isCompositeComponent(e) || e.constructor !== t);
            },
            ...
            isCompositeComponentElementWithType: function(e, t) {
              return !(!D.isCompositeComponentElement(e) || e.constructor !== t);
            },
            getRenderedChildOfCompositeComponent: function(e) {
              if (!D.isCompositeComponent(e))
                return null;
              var t = v.get(e);
            ...
            findAllInRenderedTree: function(e, t) {
              if (!e)
                return [];
              var n = t(e) ? [e] : [];
              if (D.isDOMComponent(e)) {
                var r,
                    o = v.get(e),
                    i = o._renderedComponent._renderedChildren;
                for (r in i)
                  i.hasOwnProperty(r) && i[r].getPublicInstance && (n = n.concat(D.findAllInRenderedTree(i[r].getPublicInstance(), t)));
              } else
                D.isCompositeComponent(e) && (n = n.concat(D.findAllInRenderedTree(D.getRenderedChildOfCompositeComponent(e), t)));
              return n;
            },
            scryRenderedDOMComponentsWithClass: function(e, t) {
              return D.findAllInRenderedTree(e, function(e) {
                var n = e.props.className;
                return D.isDOMComponent(e) && n && -1 !== (" " + n + " ").indexOf(" " + t + " ");
              });
            },
            findRenderedDOMComponentWithClass: function(e, t) {
              var n = D.scryRenderedDOMComponentsWithClass(e, t);
              if (1 !== n.length)
            ...
            scryRenderedDOMComponentsWithTag: function(e, t) {
              return D.findAllInRenderedTree(e, function(e) {
                return D.isDOMComponent(e) && e.tagName === t.toUpperCase();
              });
            },
            findRenderedDOMComponentWithTag: function(e, t) {
              var n = D.scryRenderedDOMComponentsWithTag(e, t);
              if (1 !== n.length)
            ...
            scryRenderedComponentsWithType: function(e, t) {
              return D.findAllInRenderedTree(e, function(e) {
                return D.isCompositeComponentWithType(e, t);
              });
            },
            findRenderedComponentWithType: function(e, t) {
              var n = D.scryRenderedComponentsWithType(e, t);
              if (1 !== n.length)
            ...
            simulateNativeEventOnDOMComponent: function(e, t, n) {
              D.simulateNativeEventOnNode(e, t.getDOMNode(), n);
            },
      ...
      var x = u.injection.injectEventPluginOrder;
      u.injection.injectEventPluginOrder = function() {
        x.apply(this, arguments), i();
      };
      ...
      var T;
      for (T in b) {
        var P = 0 === T.indexOf("top") ? T.charAt(3).toLowerCase() + T.substr(4) : T;
        D.SimulateNative[P] = a(T);
      }
      e.exports = D;
    }, function(e, t, n) {
      "use strict";
      ...
      (function(t) {
        ...
        o.addons = {
          ...
          update: d
        }, "production" !== t.env.NODE_ENV && (o.addons.Perf = n(81), o.addons.TestUtils = n(160)), e.exports = o;
      }).call(t, n(1));
    }, function(e, t, n) {
      "use strict";
      var r = n(20),
      ...
      (function(t) {
        ...
        function o(e, n) {
          ...
          for (var f = a(o.childNodes); o.lastChild; )
      ...
      (function(t) {
        "use strict";
        function r(e) {
          return "production" !== t.env.NODE_ENV && ("production" !== t.env.NODE_ENV ? o(i, "React.addons.classSet will be deprecated in a future version. See http://fb.me/react-addons-classset") : null, i = !0), "object" == typeof e ? Object.keys(e).filter(function(t) {
            return e[t];
      ...
      (function(t) {
        ...
        function o(e, n, r) {
          ...
          var o = n[r];
          "production" !== t.env.NODE_ENV ? u(Array.isArray(o), "update(): expected spec of %s to be an array; got %s. Did you forget to wrap your parameter in an array?", r, o) : u(Array.isArray(o));
        }
        function i(e, n) {
          if ("production" !== t.env.NODE_ENV ? u("object" == typeof n, "update(): You provided a key path to update() that did not contain one of %s. Did you forget to include {%s: ...}?", v.join(", "), f) : u("object" == typeof n), c.call(n, f))
            return "production" !== t.env.NODE_ENV ? u(1 === Object.keys(n).length, "Cannot have more than one key in an object with %s", f) : u(1 === Object.keys(n).length), n[f];
          var s = r(e);
          if (c.call(n, h)) {
            var g = n[h];
            "production" !== t.env.NODE_ENV ? u(g && "object" == typeof g, "update(): %s expects a spec of type 'object'; got %s", h, g) : u(g && "object" == typeof g), "production" !== t.env.NODE_ENV ? u(s && "object" == typeof s, "update(): %s expects a target of type 'object'; got %s", h, s) : u(s && "object" == typeof s), a(s, n[h]);
          }
          c.call(n, l) && (o(e, n, l), n[l].forEach(function(e) {
            s.push(e);
          })), c.call(n, p) && (o(e, n, p), n[p].forEach(function(e) {
            s.unshift(e);
          })), c.call(n, d) && ("production" !== t.env.NODE_ENV ? u(Array.isArray(e), "Expected %s target to be an array; got %s", d, e) : u(Array.isArray(e)), "production" !== t.env.NODE_ENV ? u(Array.isArray(n[d]), "update(): expected spec of %s to be an array of arrays; got %s. Did you forget to wrap your parameters in an array?", d, n[d]) : u(Array.isArray(n[d])), n[d].forEach(function(e) {
            "production" !== t.env.NODE_ENV ? u(Array.isArray(e), "update(): expected spec of %s to be an array of arrays; got %s. Did you forget to wrap your parameters in an array?", d, n[d]) : u(Array.isArray(e)), s.splice.apply(s, e);
          })), c.call(n, m) && ("production" !== t.env.NODE_ENV ? u("function" == typeof n[m], "update(): expected spec of %s to be a function; got %s.", m, n[m]) : u("function" == typeof n[m]), s = n[m](s));
          for (var E in n)
            y.hasOwnProperty(E) && y[E] || (s[E] = i(e[E], n[E]));
          return s;
        }
        var a = n(3),
            s = n(13),
