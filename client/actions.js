...
export const mergeIntoAudioGraph = typeValueAction(MERGE_INTO_AUDIO_GRAPH);
...
export const removeKeysFromAudioGraphContaining = typeValueAction(REMOVE_KEYS_FROM_AUDIO_GRAPH_CONTAINING);
