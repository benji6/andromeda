...
export const MERGE_INTO_AUDIO_GRAPH = 'MERGE_INTO_AUDIO_GRAPH';
...
export const mergeIntoAudioGraph = createAction(MERGE_INTO_AUDIO_GRAPH);
...
export const moveChannelSourceDown = createAction(MOVE_CHANNEL_SOURCE_DOWN);
export const moveChannelSourceUp = createAction(MOVE_CHANNEL_SOURCE_UP);
...
export const updateActivePatternChannel = createAction(UPDATE_ACTIVE_PATTERN_CHANNEL);
