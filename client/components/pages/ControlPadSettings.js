...
import { updateControlPadInstrument, updateControlPadNoScale, updateControlPadOctave, updateControlPadPortamento, updateControlPadRange } from '../../actions'
...
export default connect(identity)(({controlPad, dispatch, instruments}) => <div className='flex-column text-center'>
