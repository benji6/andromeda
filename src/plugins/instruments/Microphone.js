...
const turnMicOn = (self) =>
  getUserMedia(
    { audio: true },
    (stream) => {
      // microphone available
      const mediaStreamSource = audioContexts
        .get(self)
          ...
          createElement(
            ...
            createElement("input", {
              ...
              onClick: () => {
                ...
                if (microphoneOn) turnMicOn(this);
                else turnMicOff(this);
              },
              type: "checkbox",
            })
          )
        ...
        createElement(
          ...
          createElement(
            ...
            createElement("input", {
              ...
              min: 0,
              onInput: (e) =>
                (outputs.get(this).gain.value = Number(e.target.value)),
              step: 0.05,
              type: "range",
            })
          )
