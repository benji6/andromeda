...
const updateAudioGraph =
  (virtualAudioGraph) =>
  ({ dryLevel, highCut, lowCut, reverbType, wetLevel }) => {
    const bufferPromise =
      reverbTypeToBufferPromise[reverbType] ||
      fetch(reverbTypeToUri[reverbType])
...
export default class {
  ...
  render(containerEl) {
    ...
    ReactDOM.render(connect(store)(ReverbComponent), containerEl);
  }
}
